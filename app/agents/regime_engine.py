...
class RegimeEngine:
    """Classify market state without placing orders."""
    ...
    def classify(self, prices: list[float], data_age_seconds: float = 0.0) -> MarketRegime | None:
        ...
        if quality < 0.5:
            ...
            name = "RANGE"
        return MarketRegime(name, ema20, ema50, ema200, atr_percent, realized_vol_percent, trend_strength, quality)
