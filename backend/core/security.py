...
if not ADMIN_PASSWORD:
    logger.warning("ADMIN_PASSWORD is not configured; dashboard login will be unavailable until it is set")
...
DEFAULT_USERS = {}
if ADMIN_PASSWORD:
    DEFAULT_USERS[ADMIN_USERNAME] = {"username": ADMIN_USERNAME, "password": get_password_hash(ADMIN_PASSWORD)}
