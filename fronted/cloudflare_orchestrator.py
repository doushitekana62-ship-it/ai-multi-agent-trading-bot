...
class CloudflareOrchestrator:
    ...
    @staticmethod
    def _namespace(result: Dict[str,Any], engine_warning=None):
    ...
    async def analyze(self,symbol:str,market_data:Dict[str,Any]|None=None):
        ...
        result["engine_source"]="indodax_native";result["engine_warning"]=warning
