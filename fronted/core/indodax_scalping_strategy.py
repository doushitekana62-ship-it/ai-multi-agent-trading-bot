...
This file is the Cloudflare Worker packaging mirror of
core/indodax_scalping_strategy.py. Keep both files byte-for-byte synchronized;
the repository-level module remains the canonical source for the main runtime.
"""
