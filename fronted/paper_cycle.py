...
async def run_paper_cycle(env,state_api,pair="btc_idr",state_response=None):
    ...
    try:
        ...
        paper_history["agent_details"]=agents or {}
        paper_history["hold_analysis"]=getattr(result,"hold_analysis",{}) or {}
